...
#define MSG_PREHEAT_1_ALL                   _UxGT("Todo")
#define MSG_PREHEAT_1_END                   _UxGT("Boquilla")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Plataforma")
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1 _UxGT("Config")
#define MSG_PREHEAT_2                       _UxGT("Precalentar ABS")
#define MSG_PREHEAT_2_N                     MSG_PREHEAT_2 _UxGT(" ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Todo")
#define MSG_PREHEAT_2_END                   _UxGT("Boquilla")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Plataforma")
